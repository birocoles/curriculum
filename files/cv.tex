...
\newcommand{\Student}[3]{
        % name, level (MSc or PhD), expected conclusion at
		\noindent #1, #2, expected #3.}
...
\begin{wrapfigure}{r}{0.3\textwidth}
	%\vspace*{-20em}
	\vspace{-2.9in}
		\includegraphics[width=0.3\textwidth]{pictures/foto}
\end{wrapfigure}
...
\item\ThesisEntry{MSc}{Invers{\~ a}o gravim{\' e}trica 2D com v{\' i}nculo isost{\' a}tico}{2D gravity inversion with isostatic constraint}{Barbara Marcela S. Bastos}{Observat\'{o}rio Nacional, Brazil}{2018}
...
\NewPart{Current graduate students}{}

\begin{enumerate}

\item\Student{Kristoffer A. T. Hallam}{PhD}{2019}

\item\Student{Leonardo B. Vital}{PhD}{2020}

\item\Student{Andre L. A. Reis}{PhD}{2020}

\item\Student{Diego Takahashi}{PhD}{2021}
