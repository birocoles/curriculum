...
\newcommand{\Student}[6]{
	% level (MSc or PhD), main or co supervisor, name, institution, expected conclusion at
	%\noindent \textbf{[#1]} #2 supervisor of #3 at \textit{#4} (expected #5)}
	% #1 level (MSc or PhD), #2 main or co supervisor, #3 name, #4 #5 beggining/ending year,
	% #6 institution
	\noindent \textbf{#1} #2 supervisor of #3 \hfill 
	\parbox{0.1\textwidth}{\raggedleft #4--#5} \\
	\noindent\textit{#6}}
...
\begin{wrapfigure}{r}{-0.10\textwidth} 
	\centering
	\includegraphics[width=0.38\textwidth,angle=-90]{foto.jpg}
\end{wrapfigure}
...
\noindent \textbf{Title (portuguese):} \href{https://doi.org/10.6084/m9.figshare.20334651.v1}{\textit{Processamento e invers\~{a}o de dados de campos potenciais: novas abordagens}} \\
...
\noindent \textbf{doi:}\href{https://doi.org/10.6084/m9.figshare.20334651.v1}{ 10.6084/m9.figshare.20334651.v1} \\
...
\noindent \textbf{Title (portuguese):} \href{https://doi.org/10.6084/m9.figshare.20334531.v1}{\textit{Invers\~{a}o gravim\'{e}trica radial por camadas para a reconstru\c{c}\~{a}o de corpos geol\'{o}gicos 3D}} \\
...
\noindent \textbf{doi:}\href{https://doi.org/10.6084/m9.figshare.20334531.v1}{ 10.6084/m9.figshare.20334531.v1} \\
...
\item\ThesisEntry{PhD}{\href{https://doi.org/10.6084/m9.figshare.20335446.v1}{Camada  equivalente convolucional para processamento de dados potenciais}}{Convolutional equivalent ayer for potential-field data processing}{Diego Takahashi}{Observat\'{o}rio Nacional, Brazil}{2021}

\item\ThesisEntry{PhD}{\href{https://doi.org/10.6084/m9.figshare.20335326.v1}{Inversão magnética radial robusta para estimar a geometria de fontes 3D}}{Robust radial magnetic inversion for estimating the geometry of 3D sources}{Leonardo B. Vital}{Observat\'{o}rio Nacional, Brazil}{2020}
	
\item\ThesisEntry{PhD}{\href{https://doi.org/10.6084/m9.figshare.20335287.v1}{Desenvolvimentos te{\'o}ricos da camada equivalente e suas aplica{\c c}{\~o}es a dados magn{\'e}ticos}}{Theoretical developments of equivalent layer and its applications to magnetic data}{Andr\'{e} L. A. Reis}{Observat\'{o}rio Nacional, Brazil}{2020}
	
\item\ThesisEntry{PhD}{\href{https://doi.org/10.6084/m9.figshare.20335266.v1}{Modelagem regional do campo de gravidade utilizando pontos de massa em coordenadas geod{\' e}sicas}}{Regional gravity modeling by using point masses in geodetic coordinates}{Kristoffer A. T. Hallam}{Observat\'{o}rio Nacional, Brazil}{2019}

\item\ThesisEntry{MSc}{\href{https://doi.org/10.6084/m9.figshare.20335263.v1}{Invers{\~ a}o gravim{\' e}trica 2D com v{\' i}nculo isost{\' a}tico}}{2D gravity inversion with isostatic constraint}{B. Marcela S. Bastos}{Observat\'{o}rio Nacional, Brazil}{2018}
	
\item\ThesisEntry{MSc}{\href{https://doi.org/10.6084/m9.figshare.20335221.v1}{Modelagem magn\'{e}tica 3D de corpos elipsoidais}}{3D Magnetic modeling of elipsoidal bodies}{Diego Takahashi}{Observat\'{o}rio Nacional, Brazil}{2017}
	
\item\ThesisEntry{MSc}{\href{https://doi.org/10.6084/m9.figshare.20335209.v1}{Invers\~{a}o magn\'{e}tica 3D para estimar a distribui\c{c}\~{a}o de magnetiza\c{c}\~{a}o de uma amostra de rocha}}{3D Magnetic inversion to estimate the magnetization distribution of a rectangular rock sample}{Andr\'{e} L. A. Reis}{Observat\'{o}rio Nacional, Brazil}{2016}
	
\item\ThesisEntry{MSc}{\href{https://doi.org/10.6084/m9.figshare.20334867.v1}{Estimativa do vetor de magnetiza\c{c}\~{a}o total de corpos aproximadamente esf\'{e}ricos}}{Estimating the total magnetization vector of approximately spherical bodies}{Daiana P. Sales}{Observat\'{o}rio Nacional, Brazil}{2014}
...
\item\ThesisEntry{MSc}{\href{https://doi.org/10.6084/m9.figshare.20339034.v1}{An{\'a}lise de sensibilidade de aquisi{\c c}{\~a}o gravim{\'e}trica 4D de fundo oce{\^a}nico}}{Sensitivity analysis of 4D gravity survey at ocean bottom}{Andr{\'e} D. Arelaro}{Observat\'{o}rio Nacional, Brazil}{2020}

\item\ThesisEntry{PhD}{\href{https://doi.org/10.6084/m9.figshare.20339082.v1}{M{\'e}todos de invers{\~a}o de dados magn{\'e}ticos para estimar fontes regionais}}{Magnetic data inversion methods for estimating regional sources}{Marlon C. Hidalgo-Gato}{Observat\'{o}rio Nacional, Brazil}{2019}

\item\ThesisEntry{MSc}{\href{https://doi.org/10.6084/m9.figshare.20340885.v1}{Investiga\c{c}\~{a}o geof\'{i}sica do Alto do Cear\'{a} na margem equatorial brasileira -- Uma crosta continental ou uma crosta oce\^{a}nica?}}{Geophysical investigation of the Cear\'{a} Rise in the brazilian equatorial margin -- A continental crust or oceanic crust?}{Victor C. Pereira}{Observat\'{o}rio Nacional, Brazil}{2017}
	
\item\ThesisEntry{PhD}{\href{https://doi.org/10.6084/m9.figshare.20340975.v1}{Otimiza\c{c}\~{a}o computacional do m\'{e}todo da camada equivalente}}{Computational optimization of the equivalent layer method}{Fillipe C. L. Siqueira}{Observat\'{o}rio Nacional, Brazil}{2016}
...
\begin{enumerate}[leftmargin=*, label=\textbf{(\arabic*)}]
	...
	\item\Student{PhD}{co-}{Shayane P. Gonzalez}{2018}{present}{Observat{\'o}rio Nacional, Brazil}

	\item\Student{PhD}{co-}{Larissa S. Piauilino}{2018}{present}{Observat{\'o}rio Nacional, Brazil}

	\item\Student{MSc}{main}{Edson F. Luza}{2020}{present}{Observat{\'o}rio Nacional, Brazil}	
	
	\item\Student{MSc}{main}{Raimundo O. Sousa Jr}{2020}{present}{Observat{\'o}rio Nacional, Brazil}
	
	\item\Student{PhD}{co-}{India Uppal}{2021}{present}{University of Liverpool, UK}
